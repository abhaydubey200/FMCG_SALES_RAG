"""
Central configuration for the Sales & Marketing Intelligence Assistant.

All tunables (paths, model choice, retrieval knobs) live here so behavior
can be changed via .env without touching code — this is what "configuration
management" and "environment variables" (Section 20) refer to.
"""
import os
...
# --- Synthetic data volume (meets Section 4 minimums) ---
...
# --- Embeddings ---
# "neural" requires HuggingFace access + sentence-transformers (not available
# in this dev sandbox — see README "Environment Constraints"). "tfidf" is a
# genuine vector-space model (TF-IDF + cosine similarity) that needs no
# external downloads and is used as the default here.
